...
const AnsindaDashboard: React.FC = () => {
  ...
  const handleModuleClick = (title: string) => {
    ...
    if (title === 'PROJECT') {
      ...
      else if (role === 'picm') router.push('/project/picm/dashboard');
      ...
      if (role === 'material') router.push('/project/material/dashboard');
      else if (role === 'rpm') router.push('/project/material/dashboard');
      else if (role === 'top management') router.push('/project/material/dashboard');
    }
  };
